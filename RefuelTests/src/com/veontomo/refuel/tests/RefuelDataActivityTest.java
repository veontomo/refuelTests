...
public class RefuelDataActivityTest extends
	...
	protected void setUp() throws Exception {
		...
		mPriceInput = (EditText) mRefuelDataActivity.findViewById(R.id.priceInput);
		mQuantityText = (TextView) mRefuelDataActivity.findViewById(R.id.quantity);
		mQuantityInput = (EditText) mRefuelDataActivity.findViewById(R.id.quantityInput);
		mPaidText = (TextView) mRefuelDataActivity.findViewById(R.id.paid);
		mPaidInput = (EditText) mRefuelDataActivity.findViewById(R.id.paidInput);
		mFuelStationText = (TextView) mRefuelDataActivity.findViewById(R.id.fuelStation);
		mFuelStationInput = (EditText) mRefuelDataActivity.findViewById(R.id.fuelStationInput);
		mBtnSave = (Button) mRefuelDataActivity.findViewById(R.id.buttonSave);
		mBtnCancel = (Button) mRefuelDataActivity.findViewById(R.id.buttonCancel);
	}
	...
	public void testPreconditions() {
		...
		assertNotNull("text view for \"fuel station\" is missing", mFuelStationText);
		assertNotNull("edit text for \"fuel station\" is missing", mFuelStationInput);
